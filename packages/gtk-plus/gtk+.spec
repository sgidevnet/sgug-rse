...
# cp -p /usr/sgug/lib/rpm/config.{guess,sub} .
...
%install
make install DESTDIR=%{buildroot} LIBTOOL=/usr/sgug/bin/libtool INSTALL="install -p"
rm -f $RPM_BUILD_ROOT/etc/gtk/gtkrc
rm -f $RPM_BUILD_ROOT/etc/gtk/gtkrc.ja.utf8
rm -f $RPM_BUILD_ROOT/etc/gtk/gtkrc.ko.utf8
rm -f $RPM_BUILD_ROOT/etc/gtk/gtkrc.zh_CN.utf8
rm -f $RPM_BUILD_ROOT/etc/gtk/gtkrc.zh_TW.utf8
rm -f $RPM_BUILD_ROOT/sgug/etc/gtk/gtkrc
rm -f $RPM_BUILD_ROOT/sgug/etc/gtk/gtkrc.ja.utf8
rm -f $RPM_BUILD_ROOT/sgug/etc/gtk/gtkrc.ko.utf8
rm -f $RPM_BUILD_ROOT/sgug/etc/gtk/gtkrc.zh_CN.utf8
rm -f $RPM_BUILD_ROOT/sgug/etc/gtk/gtkrc.zh_TW.utf8
...
install -p -m644 -D %{SOURCE1} %{buildroot}/usr/sgug/etc/gtk/gtkrc
...
%check
make check LIBTOOL=/usr/sgug/bin/libtool
...
%{_libdir}/libgdk-1.2.s*
%{_libdir}/libgtk-1.2.s*
