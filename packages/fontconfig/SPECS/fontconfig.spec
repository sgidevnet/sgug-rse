...
%global _fontconfig_templatedir %{_prefix}/share/fontconfig/conf.avail
%global _fontconfig_masterdir %{_prefix}/etc/fonts
%global _fontconfig_confdir %{_prefix}/etc/fonts/conf.d
