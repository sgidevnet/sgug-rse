...
# License is not included in the latest release. Will be in the next one.
Source1:        https://raw.githubusercontent.com/jrfonseca/xdot.py/master/LICENSE.txt
...
# Strip the shebang from xdot.py to avoid an rpmlint warning:
sed '1{\@^#!/usr/bin/env python@d}' xdot.py > xdot.py.new &&
 touch -r xdot.py xdot.py.new &&
 mv xdot.py.new xdot.py
...
%license LICENSE.txt
%{_bindir}/xdot
%{python3_sitelib}/xdot.py
%{python3_sitelib}/__pycache__/xdot*
