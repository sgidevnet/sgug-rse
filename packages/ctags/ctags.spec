...
%posttrans etags
/usr/sgug/sbin/alternatives --install /usr/sgug/bin/etags emacs.etags /usr/sgug/bin/etags.ctags 20 \
   --slave /usr/sgug/share/man/man1/etags.1.gz emacs.etags.man /usr/sgug/share/man/man1/ctags.1.gz

%postun etags
/usr/sgug/sbin/alternatives --remove etags /usr/sgug/bin/etags.ctags || :
...
%changelog
* Thu Jun 25 2020  HAL <notes2@gmx.de> - 5.8-26
