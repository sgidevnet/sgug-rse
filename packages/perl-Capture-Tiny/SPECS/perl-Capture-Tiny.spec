...
%build
/usr/sgug/bin/perl Makefile.PL INSTALLDIRS=perl NO_PACKLIST=1
make %{?_smp_mflags}
...
%changelog
* Sun Jun 21 2020 David Stancu <dstancu@nyu.edu> - 0.48-7
- Rebuilt for RSE, use sed instead of shell eval for MODULE_COMPAT eval
