...
%configure \
  --disable-static \
  --enable-release \
  --with-icu-config=/usr/sgug/bin/icu-config
...
%changelog
* Mon Sep 28 2020  HAL <notes2@gmx.de> - 2.0.15-19
- compiles on Irix 6.5 with sgug-rse gcc 9.2. A few tests are failing (-build with --nocheck).
