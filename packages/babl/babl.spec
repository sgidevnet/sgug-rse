...
%build
export LD_LIBRARYN32_PATH=%{_builddir}/babl-0.1.78/mips-sgug-irix/babl
%meson
%meson_build
%install
%meson_install
...
%changelog
* Sun Aug 30 2020  HAL <notes2@gmx.de> - 0.1.78-1
- compiles on Irix 6.5 with sgug-rse gcc 9.2 but 2 tests fail.
