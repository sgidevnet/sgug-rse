...
Patch100:       imlib2.sgifixes01.patch
Patch101:       imlib2.sgifixes02.patch
...
BuildRequires:  libid3tag-devel pkgconfig
...
Requires:       freetype-devel >= 2.1.9-4 pkgconfig
...
%patch100 -p1 -b .sgifixes01
%patch101 -p1 -b .sgifixes02
