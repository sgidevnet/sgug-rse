...
Patch1:         gstreamer1.sgifixes.patch
...
%patch1 -p1 -b gstreamer1.sgifixes
...
rm -rf $RPM_BUILD_ROOT/usr/sgug/share/gtk-doc/html/*
#%%ldconfig_scriptlets
...
%changelog
* Tue Dec 01 2020  HAL <notes2@gmx.de> - 1.16.2-1
