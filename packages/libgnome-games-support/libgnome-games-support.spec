...
Source0:        https://download.gnome.org/sources/libgnome-games-support/1.4/libgnome-games-support-%{version}.tar.xz
...
%changelog
* Wed Nov 25 2020  HAL <notes2@gmx.de> - 1.4.3-3
- compiles on Irix 6.5 with sgug-rse gcc 9.2 passing the test.
