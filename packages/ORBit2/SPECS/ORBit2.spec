...
Patch100: ORBit2+.sgifixes.patch
...
%configure --without-gtk-doc --enable-purify --disable-static
make %{?_smp_mflags}
...
%changelog
* Mon Jun 17 2020  HAL <notes2@gmx.de> - 2.14.19-22
