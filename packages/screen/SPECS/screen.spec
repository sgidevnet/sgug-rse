...
BuildRequires:  ncurses-devel autoconf texinfo
...
export CPPFLAGS="-D_SGI_SOURCE -D_SGI_REENTRANT_FUNCTIONS -DNAMEDPIPE"
...
%attr(755,root,root) /var/run/screen
%else
%attr(2755,root,screen) %{_bindir}/screen
%attr(775,root,screen) /var/run/screen
%endif
