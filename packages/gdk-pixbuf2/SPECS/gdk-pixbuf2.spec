...
Patch0:         gdkpixbuf4.irixfixes.patch
...
export LD_LIBRARYN32_PATH=%{_builddir}/gdk-pixbuf-2.40.0/mips-sgug-irix/gdk-pixbuf/:$LD_LIBRARYN32_PATH
export LD_LIBRARYN32_PATH=%{_builddir}%{_libdir}/gdk-pixbuf-2.0/2.10.0/:$LD_LIBRARYN32_PATH

%meson -Dbuiltin_loaders=no \
       -Ddocs=false \
