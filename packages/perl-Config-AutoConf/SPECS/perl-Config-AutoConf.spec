...
%build
/usr/sgug/bin/perl Makefile.PL INSTALLDIRS=vendor NO_PACKLIST=1 NO_PERLLOCAL=1
%{make_build}
...
%changelog
* Tue Jun 23 2020 David Stancu <dstancu@nyu.edu> - 0.318-3
- Rebuilt for RSE
- Fix MODULE_COMPAT macro
