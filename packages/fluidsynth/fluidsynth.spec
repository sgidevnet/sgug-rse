...
#%%endif
export CFLAGS="-I%{_includedir}/libdicl-0.1 -D_SGI_SOURCE -DLIBDICL_NEED_GETOPT=1 -D_SGI_MP_SOURCE -D_SGI_REENTRANT_FUNCTIONS $RPM_OPT_FLAGS"
export CXXFLAGS="$CFLAGS"
export LDFLAGS="-ldicl-0.1 -lc $RPM_LD_FLAGS"
%{cmake}  -Denable-ladspa=off ..
cd $PREVWD
#popd
...
%{_docdir}/fluidsynth-devel/*
%doc %{_target_platform}/doc/*
%doc ChangeLog
...
%changelog
* Wed Apr 21 2021  HAL <notes2@gmx.de> - 1.1.11-6
