...
Patch100:   libzip.sgifixes.patch
...
%check
export LD_LIBRARYN32_PATH=%{_builddir}/libzip-1.5.2/lib:$LD_LIBRARYN32_PATH
%if %{with_tests}
make check
%else
: Test suite disabled
...
%changelog
* Thu Apr 22 2021  HAL <notes2@gmx.de> - 
- builds on Irix 6.5 with sgug-rse gcc 9.2.
- please build with option --nocheck since 4 tests fail.
