...
Patch100: 		netsurf.sgifixes.310.patch
...
#Patch1:         0001-Remove-extra-braces-to-fix-build-with-gcc-7.patch
...
%global gtk_make_opts %{common_make_opts} TARGET=gtk3 V=1 \\\
...
%install
#%make_install PREFIX=%{_prefix} TARGET=gtk3 NETSURF_GTK_MAJOR=3 NETSURF_LOG_LEVEL=DEEPDEBUG LDFLAGS="$LDFLAGS -ldicl-0.1 -liconv $RPM_LD_FLAGS"
i#export PKG_CONFIG_PATH="/usr/sgug/lib32/pkgconfig"
