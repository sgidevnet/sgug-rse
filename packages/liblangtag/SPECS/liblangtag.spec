...
export LDFLAGS="$RPM_LD_FLAGS -lgen -ldicl-0.1"
export LD_LIBRARYN32_PATH=%{_builddir}/liblangtag-0.6.2/liblangtag/.libs/:%{_builddir}/liblangtag-0.6.2/liblangtag-gobject/.libs/
#export LD_LIBRARYN32_PATH=%{_builddir}/liblangtag-0.6.2/liblangtag-gobject/.libs/
...
%changelog
* Mon Sep 28 2020  HAL <notes2@gmx.de> - 0.6.2-8
