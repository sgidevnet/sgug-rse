...
%configure --with-libxml2 --disable-static --disable-dependency-tracking --with-gsfontdir=/usr/sgug/share/fonts/urw-base35
%make_build
...
%changelog
* Sat Feb 06 2021  HAL <notes2@gmx.de> - 0.2.12-2
