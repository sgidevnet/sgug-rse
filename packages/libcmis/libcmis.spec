...
Patch100:    libcmis.sgifixes.patch
...
export LD_LIBRARYN32_PATH=%{buildroot}/libcmis-0.5.2-3.sgug.mips/usr/sgug/lib32
...
%changelog
* Sun Oct 01 2020  HAL <notes2@gmx.de> - 0.5.2-3
- compiles on Irix 6.5 with sgug-rse gcc 9.2. All tests pass except the api-test.
