...
perl -pi -e "s|/usr/local/bin/xcalib|/usr/sgug/bin/xcalib|g" %{_builddir}/xcalib-0.8/Makefile.cflags
perl -pi -e "s|/usr/local/bin/|/usr/sgug/bin/|g" %{_builddir}/xcalib-0.8/Makefile.cflags
perl -pi -e "s|/usr/bin/xcalib|/usr/sgug/bin/xcalib|g" %{_builddir}/xcalib-0.8/Makefile
perl -pi -e "s|/usr/bin/|/usr/sgug/bin/|g" %{_builddir}/xcalib-0.8/Makefile

# Convert file-not-utf8
iconv -f iso8859-1 -t utf-8 README > README-utf-8 
...
%changelog
* Wed Jan 27 2021  HAL <notes2@gmx.de> - 0.8-24
