...
Patch0:    hunspell.sgifixes.patch
...
configureflags="--enable-rpath --disable-static --with-ui --with-readline"
...
head -n $((`cat /usr/sgug/share/dict/words | wc -l`/2)) /usr/sgug/share/dict/words |\
    sed '/\//d'> words
...
#./src/tools/hunspell -d words -l /usr/sgug/share/dict/words > /dev/null
#make check
#make distclean
