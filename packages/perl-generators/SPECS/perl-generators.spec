...
# Hack to work around external rpm not pointing to correct internal
# place
%define localrpmconfigdir %{_prefix}/lib/rpm
...
mkdir -p %{buildroot}%{localrpmconfigdir}/fileattrs/
install -p -m 644 fileattrs/* '%{buildroot}%{localrpmconfigdir}/fileattrs'
...
%files
%doc Changes TODO
%{localrpmconfigdir}/perl.*
%{localrpmconfigdir}/fileattrs/perl*.attr

%changelog
* Fri Apr 10 2020 Daniel Hams <daniel.hams@gmail.com> - 1.11-5
