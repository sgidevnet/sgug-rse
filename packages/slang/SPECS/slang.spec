...
perl -pi -e "s|#!/usr/bin/env slsh|#!/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/jpegsize
perl -pi -e "s|#!/usr/bin/env slsh|#!/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/sldb
perl -pi -e "s|#!/usr/bin/env slsh|#!/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/svnsh
perl -pi -e "s|#!/usr/bin/env slsh|#!/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/slprof
perl -pi -e "s|#!/usr/bin/env slsh|#!/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/slstkchk
perl -pi -e "s|/usr/bin/env slsh|/usr/sgug/bin/env slsh|g" %{buildroot}/usr/sgug/share/slsh/scripts/lsrpm
