...
Patch100:   libpq2.sgifixes.patch
BuildRequires: gcc
...
%changelog
* Sat Feb 20 2021  HAL <notes2@gmx.de> - 12.3-1
- initial commit which adds all the irix-related bits that were removed after 9.3.25
  it get's you through configure but eventually fails.
