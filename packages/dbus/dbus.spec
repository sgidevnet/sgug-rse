...
%global dbus_common_config_opts --enable-selinux=no --with-dbus-user=dbus --libexecdir=/%{_libexecdir}/dbus-1 --enable-user-session --docdir=%{_pkgdocdir}
...
%configure %{dbus_common_config_opts} --disable-dbus --disable-systemd --disable-doxygen-docs --disable-ducktype-docs --enable-xml-docs --disable-asserts
make distclean
...
%configure %{dbus_common_config_opts} --disable-doxygen-docs --disable-ducktype-docs --enable-xml-docs --disable-asserts
...
rm -rf $RPM_BUILD_ROOT/usr/sgug/lib32/systemd
rm -f $RPM_BUILD_ROOT/usr/sgug/share/doc/dbus/examples/*
...
%changelog
* Sat Sep 26 2020  HAL <notes2@gmx.de> - 1:1.12.20-1
