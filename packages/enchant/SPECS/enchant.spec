...
%build
%configure --enable-myspell --with-myspell-dir=/usr/sgug/share/myspell --disable-static --disable-ispell --disable-hspell --disable-zemberek
make %{?_smp_mflags}
...
%changelog
* Sat Jun 20 2020  HAL <notes2@gmx.de> - 1:1.6.0-24
