...
INSTALL_INCDIR=%{_includedir} %{_bindir}/bash ./configure --sysconfdir=%{_sysconfdir} --exec-prefix=%{_prefix} --mandir=%{_mandir} --libdir=%{_libdir}
...
%changelog
* Sun May 10 2020 Daniel Hams <daniel.hams@gmail.com> - 1.3.8-2
- Import into wip
