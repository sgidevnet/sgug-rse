...
Source0: https://www.puimula.org/htp/ooo/voikko-mac/3.0.99.20090411/malaga-7.12.tgz
...
make install DESTDIR=$RPM_BUILD_ROOT INSTALL_INFO=/usr/sgug/sbin/install-info INSTALL="install -p"
...
%changelog
* Sun Jun 21 2020 David Stancu <dstancu@nyu.edu> - 7.12-29
- Rebuilt for RSE, change install-info path, u_short_t -> short in cell values.h
