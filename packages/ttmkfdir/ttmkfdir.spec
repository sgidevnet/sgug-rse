...
Patch100:      ttmkfdir.sgifixes.patch
...
%build
export RPM_OPT_FLAGS="-D_SGI_SOURCE -D_SGI_REENTRANT_FUNCTIONS -I%{_includedir}/libdicl-0.1 -DLIBDICL_NEED_GETOPT=1 $RPM_OPT_FLAGS"
export RPM_LD_FLAGS="-ldicl-0.1 $RPM_LD_FLAGS"
...
mv $RPM_BUILD_ROOT/usr/bin/ttmkfdir $RPM_BUILD_ROOT%{_bindir}/
...
%changelog
* Tue Apr 14 2020 Daniel Hams <daniel.hams@gmail.com> - 3.0.9-57
- Import into wip
