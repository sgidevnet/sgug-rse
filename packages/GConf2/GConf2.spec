...
Patch101: Gconf.sgifixes.patch
Patch102: Gconf2.sgifixes.patch
...
%patch101 -p1 -b Gconf.sgifixes
%patch102 -p1 -b Gconf2.sgifixes

perl -pi -e "s|/usr/bin|%{_bindir}|g" gconf/gconftool.c
perl -pi -e "s|/usr/bin|%{_bindir}|g" aclocal.m4
perl -pi -e "s|/usr/bin|%{_bindir}|g" config.guess
perl -pi -e "s|/usr/bin|%{_bindir}|g" configure
...
%build
%configure --disable-static --without-gtk-doc --disable-orbit --without-openldap --with-gtk=2.0
#%configure --disable-static --without-gtk-doc \
#      %{?defaults_service:--enable-defaults-service} \
#      %{!?defaults_service:--disable-defaults-service} \
#      --disable-orbit --without-openldap --with-gtk=2.0
...
%changelog
* Sat Sep 19 2020  HAL <notes2@gmx.de> - 3.2.6-27
- compiles on Irix 6.5 with sgug-rse gcc 9.2. Built with gtk2 support.
