...
autoreconf -i
export CFLAGS="-std=gnu99 -I%{_includedir}/libdicl-0.1 -DLIBDICL_NEED_GETOPT=1"
export LIBS="-ldicl-0.1"
%configure --without-external-gtest
...
%changelog
* Sun Nov 01 2020  HAL <notes2@gmx.de> - 5.2.0-5
- compiles on Irix 6.5 with sgug-rse gcc 9.2. Some tests fail.
