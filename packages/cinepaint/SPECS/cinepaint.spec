...
Source0: http://prdownloads.sourceforge.net/cinepaint/cinepaint-0.21-0.tar.gz
...
The profile viewer 'ICC Examin' is available from www.behrmann.name
...
make install \
        DESTDIR=%{buildroot}
rm -rf %{buildroot}/usr/sgug/share/locale
...
install -m 644 $RPM_BUILD_DIR/cinepaint-%{version}-%{release}/cinepaint.desktop %{buildroot}/%{_datadir}/applications
mkdir -p %{buildroot}/%{_datadir}/pixmaps
install -m 644 $RPM_BUILD_DIR/cinepaint-%{version}-%{release}/cinepaint.png %{buildroot}/%{_datadir}/pixmaps
