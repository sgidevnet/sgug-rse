...
%prep
%setup -q
%patch100 -p1 -b orc.sgifixes.patch

%build
%meson -D default_library=shared -Dorc-backend=mips -Dgtk_doc=disabled -Dtests=disabled -Dexamples=disabled
%meson_build
...
%changelog
* Wed Dec 30 2020  HAL <notes2@gmx.de> - 0.4.30-1
