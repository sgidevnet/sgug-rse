...
%build
find . -type f -exec sed -i 's,#!/usr/bin/perl,#!#/usr/sgug/bin/perl,g' {} +
...
%changelog
* Sun Jun 21 2020 David Stancu <dstancu@nyu.edu> - 0.03-38
- Rebuilt for RSE, replace /usr/bin/perl with /usr/sgug/bin/perl
