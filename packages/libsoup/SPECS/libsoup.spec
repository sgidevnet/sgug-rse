...
Source0: https://download.gnome.org/sources/%{name}/2.68/%{name}-%{version}.tar.xz
Patch100: libsoup.sgifixes.patch
...
%changelog
* Sat Sep 26 2020  HAL <notes2@gmx.de> - 2.68.4-1
- compiles on Irix 6.5 with sgug-rse gcc 9.2.

* Wed Feb 26 2020 Kalev Lember <klember@redhat.com> - 2.68.4-1
- Update to 2.68.4
