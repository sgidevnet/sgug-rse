...
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/da
unzip -j %{SOURCE10}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/de
unzip %{SOURCE11}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/es
unzip %{SOURCE12}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/fr
unzip %{SOURCE13}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/it
unzip -j %{SOURCE14}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/ko
unzip %{SOURCE15}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/pt
unzip %{SOURCE16}
cd $PREVWD
#popd
#pushd
PREVWD=`pwd`
cd %{buildroot}%{_datadir}/dosbox/translations/ru
unzip %{SOURCE17}
cd $PREVWD
#popd
...
%changelog
* Sat Apr 10 2021  HAL <notes2@gmx.de> - 0.74.3-4
