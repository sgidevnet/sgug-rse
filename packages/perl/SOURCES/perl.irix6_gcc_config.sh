...
libs='-lpthread -lc -ldb -lm'
libsdirs=' /usr/lib32 DIDBSINSTALLPREFIX/lib32'
libsfiles='libpthread.so libc.so libdb.so libm.so'
libsfound=' /usr/lib32/libpthread.so /usr/lib32/libcl.so DIDBSINSTALLPREFIX/lib/libdb.so /usr/lib32/libm.so'
