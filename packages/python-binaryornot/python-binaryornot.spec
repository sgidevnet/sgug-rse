...
BuildArch:          noarch
# Fix compatibility with Hypothesis 4.0 which removed the 'average_size' argument.
# Sent upstream:    https://github.com/audreyr/binaryornot/pull/42
Patch0:             fix-hypothesis-4.0-compatibility.patch
