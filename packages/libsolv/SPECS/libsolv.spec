...
%check
export TEST_LIB_ROOT=`pwd`/mips-sgug-irix
export LD_LIBRARYN32_PATH=$TEST_LIB_ROOT/src:$TEST_LIB_ROOT/ext:$TEST_LIB_ROOT/bindings/python:$TEST_LIB_ROOT/bindings/perl:$LD_LIBRARYN32_PATH
