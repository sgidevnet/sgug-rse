...
iconv -f latin1 -t utf-8 < Changes > Changes.utf8
...
sed -e 's;/usr/sgug/share/X11/fonts;%{_datadir}/X11/fonts;' \
  -e 's;/usr/sgug/share/fonts/type1;%{_datadir}/fonts %{_datadir}/texmf/fonts;' \
  -e 's;/usr/sgug/etc/t1lib/;%{_datadir}/t1lib/;' \
