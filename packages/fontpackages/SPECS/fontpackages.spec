...
# Obsoleted, comes from fonts-rpm-macros now
#%%package filesystem
...
%changelog
* Thu Jul 23 2020 Fedora Release Engineering <daniel.hams@gmail.com> - 1.44-26
- Fix up, remove patch, only output RPMs we can install
