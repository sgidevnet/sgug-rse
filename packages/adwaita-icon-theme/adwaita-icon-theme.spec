...
Source0:        http://download.gnome.org/sources/adwaita-icon-theme/3.34/%{name}-%{version}.tar.xz
...
# Work around to gtk3 being built in debug (which means no RPATH)
export LD_LIBRARYN32_PATH=%{_libdir}:$LD_LIBRARYN32_PATH
gtk-update-icon-cache --force %{_datadir}/icons/Adwaita
...
%changelog
* Wed Mar 04 2020 Kalev Lember <klember@redhat.com> - 3.34.3-2
- Rebuild
