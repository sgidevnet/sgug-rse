...
%patch1000 -p1
# A place to generate the "-orig" directory to diff against
exit 1
...
#export CFLAGS="-I%{_includedir}/libdicl-0.1 %{extension_cflags} -D_SGI_SOURCE -D_SGI_REENTRANT_FUNCTIONS -fPIC -fwrapv"
#export CFLAGS_NODIST="-I%{_includedir}/libdicl-0.1 %{build_cflags} -D_SGI_SOURCE -D_SGI_REENTRANT_FUNCTIONS -fPIC -fwrapv"
#export CXXFLAGS="$CFLAGS"
#export CPPFLAGS="$(pkg-config --cflags-only-I libffi)"
#export OPT="-I%{_includedir}/libdicl-0.1 %{extension_cflags} -D_SGI_SOURCE -D_SGI_REENTRANT_FUNCTIONS -fPIC -fwrapv"
#export LINKCC="gcc"
#export CFLAGS="$CFLAGS $(pkg-config --cflags openssl)"
#export LDFLAGS="-ldicl-0.1 -lpthread %{extension_ldflags} -g $(pkg-config --libs-only-L openssl)"
#export LDFLAGS_NODIST="-ldicl-0.1 -lpthread %{build_ldflags} -g $(pkg-config --libs-only-L openssl)"
