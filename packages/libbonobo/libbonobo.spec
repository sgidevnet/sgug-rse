...
Patch100: libbonobo4.sgifixes.patch
%description
...
mkdir -p $RPM_BUILD_ROOT%{_prefix}/lib32/bonobo/servers
...
%{_libexecdir}/*
%{_sbindir}/*
%dir %{_prefix}/lib32/bonobo/servers
%dir %{_prefix}/lib32/bonobo
...
%changelog
* Sun Jun 28 2020  HAL <notes2@gmx.de> - 2.32.1-17
