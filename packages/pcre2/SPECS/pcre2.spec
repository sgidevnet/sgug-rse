...
* Mon Jan 13 2020 Petr Pisar <ppisar@redhat.com> - 10.34-3
- Fix a crash in pcre2_jit_compile when passing a NULL code argument (upstream
  bug #2487)

* Mon Jan 13 2020 Petr Pisar <ppisar@redhat.com> - 10.34-2
- Fix JIT to respect NOTEMPTY options (upstream bug #2473)

* Mon Jan 13 2020 Petr Pisar <ppisar@redhat.com> - 10.34-1
- 10.34 bump

* Mon Jan 13 2020 Petr Pisar <ppisar@redhat.com> - 10.34-0.1.RC2
- 10.34-RC2 bump
- Fix an infinite loop in 64-bit ARM JIT with NEON instructions

* Mon Jan 13 2020 Petr Pisar <ppisar@redhat.com> - 10.34-0.1.RC1
- 10.34-RC1 bump

* Mon Nov 18 2019 Petr Pisar <ppisar@redhat.com> - 10.33-16
