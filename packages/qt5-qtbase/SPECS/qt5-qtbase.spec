...
OPENSSL_LIBS='-L/usr/sgug/lib32/ssl/lib -lssl -lcrypto'
./configure \
  -verbose \
  -confirm-license \
  -opensource \
...
%changelog
* Sun Dec 27 2020  HAL <notes2@gmx.de> - 5.13.2-3
- 1st effort to pass initial tests and start the build.

* Wed Apr 08 2020 Than Ngo <than@redhat.com> - 5.13.2-3
...
* Wed Dec 18 2019 Jan Grulich <jgrulich@redhat.com> - 5.13.2-1
- 5.13.2
