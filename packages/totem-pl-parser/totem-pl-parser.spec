...
Patch100:  totem-pl-parser.sgifixes.patch
...
rm -f $RPM_BUILD_ROOT/usr/sgug/libexec/totem-pl-parser/99-totem-pl-parser-videosite-quvi
#%%ldconfig_scriptlets
...
%changelog
* Tue May 04 2021  HAL <notes2@gmx.de> - 3.26.5-1
...
* Tue Nov 12 2019 Kalev Lember <klember@redhat.com> - 3.26.4-1
- Update to 3.26.4
