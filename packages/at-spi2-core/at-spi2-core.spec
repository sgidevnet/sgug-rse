...
Patch100:       at-spi2-core.sgifixes.patch
...
%build
%meson -Ddocs=false -Dsystemd_user_dir=no -Ddbus_broker=no -Ddbus_daemon=no
%meson_build
...
#%%ldconfig_scriptlets
rm -f $RPM_BUILD_ROOT/usr/sgug/no/at-spi-dbus-bus.service
...
%changelog
* Sun Sep 20 2020  HAL & bplaa.yai <notes2@gmx.de> - 2.34.0-1
