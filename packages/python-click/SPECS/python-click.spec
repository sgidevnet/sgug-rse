...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} pytest-%{python3_pkgversion} -v tests
...
%changelog
* Mon Apr 27 2020 Fabian Affolter <mail@fabian-affolter.ch> - 7.1.1-1.1
- Re-add Python 2 (rhbz#1828167)
