...
Patch100: imake.sgiperlfix.patch
...
%patch100 -p1 -b .sgiperlfix

# Rewrite references to /bin/sh to /usr/sgug/bin/sh
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/ccmakedep
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/cleanlinks
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/gccmakedep
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/makeg
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/mergelib
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/mkdirhier
perl -pi -e "s|/bin/sh|%{_bindir}/sh|g" imake-1.0.8/xmkmf
