...
%meson -Dgtk_doc=false -Dsse=false -Darm_neon=false -Dtests=false -Dinstalled_tests=false -Dgobject_types=true -Dintrospection=true
%meson_build
...
%changelog
* Thu Nov 26 2020  HAL <notes2@gmx.de> - 1.10.2-1
