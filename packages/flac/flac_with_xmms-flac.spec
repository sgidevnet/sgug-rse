...
BuildRequires: gcc gcc-c++ automake autoconf libtool gettext-devel
%if %{with_xmms}
...
export CFLAGS="%{optflags} -funroll-loops -DHAVE_SOCKLEN_T"
%configure \
...
# Remove half-finished docs
rm -rf $RPM_BUILD_ROOT/%{_docdir}/flac-%{version}/html
rm -rf $RPM_BUILD_ROOT/%{_docdir}/flac-%{version}/FLAC.tag
...
%changelog
* Wed Dec 30 2020  HAL <notes2@gmx.de> - 1.3.2-2
- added xmms-flac since we now have xmms 1.2 available. 
