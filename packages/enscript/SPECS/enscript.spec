...
Patch100:   enscript.sgifixes.patch
...
%patch100 -p1 -b enscript.sgifixes
...
export CPPFLAGS="-I%{_includedir}/libdicl-0.1 -DPROTOTYPES"
export LDFLAGS="-ldicl-0.1 -lc $RPM_LD_FLAGS -lgen"
...
for all in README THANKS; do
	iconv -f ISO_8859-1 -t UTF-8 < $all > $all.new
	touch -r $all $all.new
	mv $all.new $all
done
...
%changelog
* Sun Dec 27 2020  HAL <notes2@gmx.de> - 1.6.6-21
