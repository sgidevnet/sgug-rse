...
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//nroff-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//sgml-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//context-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//email-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//tex-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//texinfo-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/aspell-0.60//markdown-filter.so
chrpath -d ${RPM_BUILD_ROOT}%{_bindir}/aspell
chrpath -d ${RPM_BUILD_ROOT}%{_libdir}/libpspell.so.*
